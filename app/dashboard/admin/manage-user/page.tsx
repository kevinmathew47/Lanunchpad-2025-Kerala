              ...
              {filtered.length === 0 ? (
                ...
                filtered.map((company) => (
                  <TableRow key={company.id}>
                    <TableCell className="text-white font-medium">{company.companyName}</TableCell>
                    <TableCell className="text-gray-200">{company.contactPerson}</TableCell>
                    <TableCell className="text-gray-200">{company.email}</TableCell>
                    <TableCell className="text-gray-200">{company.phone}</TableCell>
                    <TableCell>
                      <Badge
                        className={
                    ...
                    <TableCell className="text-gray-400">{company.registeredAt}</TableCell>
                  </TableRow>
                ))
              )}
            </TableBody>
